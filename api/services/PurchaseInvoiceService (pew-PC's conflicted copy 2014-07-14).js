...
// ---------------------------------------------------------------
// REFACTOR LATER
var totalPriceBeforeDiscount2 = function (obj) {
  ...
  return sumNumberArray(totalPrices);
};

// REFACTOR LATER
exports.totalPriceAfterDiscount2 = function (obj) {
  return totalPriceBeforeDiscount2(obj) * (1 - obj.discount / 100);
};

// ---------------------------------------------------------------

var pluckTotalPriceAfterDiscount = function( invoice ) {
  return exports.totalPriceAfterDiscount(invoice);
};

exports.getProfit = function() {
  getInvoice({}, function( invoices ) {
    var totalPrices = invoices.map(pluckTotalPriceAfterDiscount);

    return totalPrices.reduce(function( sum, num ) {
      return sum + num;
    });
  });
};